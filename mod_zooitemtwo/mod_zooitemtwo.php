...
//register base path
$zoo->path->register($path, 'mod_zooitemtwo');

if ($application = $zoo->table->application->get($params->get('application', 0))) {


	$items = $zoo->module->getItemswithoffsettwo($params);
	...
	include(JModuleHelper::getLayoutPath('mod_zooitemtwo', $params->get('theme', 'list')));
}